...
const PostList = ({posts, handleDelete, handleLike, handleUnlike, handleComment, commentsCount = 10, removeComment}) => {
                                ...
                                <span className='badge rounded-pill text-muted'>
                                    ...
                                    {state && state.user && state.user._id === c.postedBy._id && (
                                        <div className="ml-auto mt-1">
                                            <button onClick={() => removeComment(post._id, c)} className="btn-sm btn btn-danger">Delete</button>
                                        </div>
                                    )}
                                </span> 
                            </li>  
